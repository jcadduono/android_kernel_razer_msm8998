...
#define ERROR_READ_B2					(int)0x80000400							//B2 comand failed
...
#define ERROR_SENSE_ON_FAIL				(int)0x80000900							//the comand Sense On failed
#define ERROR_SENSE_OFF_FAIL			(int)0x80000A00							//the comand Sense Off failed
